...
const App = () => {
  return (
    <>
      <Navbar color='danger'>
        <h1 style={{ color: 'white', textShadow: '3px 3px 5px #000000' }}>
          Lambda Pizzeria
        </h1>
        <Link to={'/'}>
        ...
        <Card>
          ...
          <Link to={'/pizza'}>
            <h1
              ...
              Your favorite food delivery while coding...
            </h1>
            <Button
              color='success'
              size='lg'
        ...
        <CardGroup>
          <Card>
            <CardImg
              ...
              src={require('./Assets/pizzaA.png')}
            />
            <CardBody>
              <CardTitle style={{ margin: '0 0 10px 40px' }}>
                Margarita Pizza
              </CardTitle>
              <Link to={'/pizza'}>
                <Button
